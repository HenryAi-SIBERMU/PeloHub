  ...
  return (
    <div className="p-6 md:p-8 flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Documentation & Definitions</h1>
          <p className="text-slate-500 dark:text-gray-400">Glossary of performance indicators and research methodologies</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              desc: "A Fourier-related transform used to determine the sinusoidal frequency and phase content of local sections of a signal as it changes over time.",
              formula: "STFT{x[n]}(m, ω)",
              usage: "Feature extraction for CNN inputs."
            }
          ].map((item, idx) => (
